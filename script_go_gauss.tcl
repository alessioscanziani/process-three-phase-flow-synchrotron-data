...
set interface_file_go "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\interface_go_gauss"
# mean curvatures go
set km_go "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\gauss_go"
# distance vectors go
set distance_go "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\gauss_dist_go"
# interfacial area go
set area_csv_go "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\area_csv_go_gauss"
...
for {set i $tomo_first} {$i <= $tomo_last} {set i [expr $i+$tomo_inc]} {
	...
	set fnparts5 "_interfacial_area_go.csv"
	set fnparts6 "_interface_go.am"
	set fnparts7 "_gauss_curvature_go.am"
	set fnparts8 "_dist_gcurvature_go.am"
	...
	# Find interface between material 4 (index 5) and 0 (index 1)
	...
	set fileId [open "$area_csv_go\\$filename5" "w"]
	puts -nonewline $fileId $area_val
	close $fileId
	unset area_val
	
	"interface" save "Avizo" "$interface_file_go\\$filename6"
	"GaussCurvature" save "Avizo ascii" "$km_go\\$filename7"
	"distance_km" save "Avizo ascii" "$distance_go\\$filename8"
