...
# output
# interface surface gw
set interface_file_gw "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\interface_gw_gauss"
# mean curvatures gw
set km_gw "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\gauss_gw"
# distance vectors gw
set distance_gw "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\gauss_dist_gw"
# interfacial area gw
set area_csv_gw "E:\\Diamond19\\processing\\DK_GI\\curv_ia\\area_csv_gw_gauss"
...
for {set i $tomo_first} {$i <= $tomo_last} {set i [expr $i+$tomo_inc]} {
	...
	set fnparts5 "_interfacial_area_gw.csv"
	set fnparts6 "_interface_gw.am"
	set fnparts7 "_gauss_curvature_gw.am"
	set fnparts8 "_dist_gcurvature_gw.am"
	...
	# Find interface between material 4 (index 5) and 2 (index 3)
	...
	set fileId [open "$area_csv_gw\\$filename5" "w"]
	puts -nonewline $fileId $area_val
	close $fileId
	unset area_val
	
	"interface" save "Avizo" "$interface_file_gw\\$filename6"
	"GaussCurvature" save "Avizo ascii" "$km_gw\\$filename7"
	"distance_km" save "Avizo ascii" "$distance_gw\\$filename8"
